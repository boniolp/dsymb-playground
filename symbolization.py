        ...
        for _, group in features_with_symbols_df.groupby("signal_index"):
            ...
            for index_row in sorted(l_index_rows_signal, reverse=True):
                features_with_symbols_df.loc[
                    index_row - 1, "segment_end"
                ] = features_with_symbols_df["segment_end"].iloc[index_row]
                features_with_symbols_df.loc[
                    index_row - 1, "segment_length"
                ] += features_with_symbols_df["segment_length"].iloc[index_row]
